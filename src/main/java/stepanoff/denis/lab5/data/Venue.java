...
public class Venue {
     ...
     * @param idManager Venue Id Manager
     * @see IdManager
     * @see Collection
     * @return Builder for Venue with new id
     */
    public static Builder newVenue(IdManager idManager) {
        return new Builder().id(idManager.getNewId(false));
    }
